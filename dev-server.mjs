...
http.createServer(async (req, res) => {
  try {
    ...
    if (!['index.html', 'styles.css', 'script.js', 'motion.js', 'special/index.html', 'special/special.css', 'special/special.js'].includes(relative) && !/^img\/[a-z0-9_-]+\.(png|jpg)$/i.test(relative)) {
